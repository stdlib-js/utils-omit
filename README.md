...
```javascript
import omit from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-omit@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-omit/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/utils-omit/actions/workflows/test.yml?query=branch:v0.2.0
